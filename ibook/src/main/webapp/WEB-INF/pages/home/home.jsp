...
<link rel="stylesheet" type="text/css"
	href="${ctx}/staticfile/bootstrap-3.3.6-dist/css/bootstrap.css">
<link rel="stylesheet" type="text/css"
	href="${ctx}/staticfile/font-awesome-4.5.0/css/font-awesome.css">
<link rel="stylesheet" type="text/css"
	href="${ctx}/staticfile/css/slider.css">
<link rel="stylesheet" type="text/css"
	href="${ctx}/staticfile/css/mystyle.css">
</head>
<body>
	<!-- Header -->
	<div class="allcontain">
		...
		<font color="#FFFFFF">您好:&nbsp;${_CURRENT_USER.username}&nbsp;&nbsp;|</font>&nbsp;&nbsp;<a
					href="tologout.action"><font color="#7af4f5">注销</font></a>
			</c:if>
			<c:if test="${_CURRENT_USER.username==null }">
				<ul class="logreg">
					<li><a href="tologin.action">Login </a></li>
					<li><a href="toregist.action"><span class="register">Register</span></a></li>
				</ul>
			</c:if>
		</div>
		<!-- Navbar Up -->
		<nav class="topnavbar navbar-default topnav">
			...
			<div class="collapse navbar-collapse" id="upmenu">
				<ul class="nav navbar-nav" id="navbarontop">
					<li class="active"><a href="home.action">主页</a></li>
					<!--<li class="dropdown">
					...
					<li class="active"><a href="productListAll.action">书架</a></li>

					<li class="action"><a href="order/list.action">我的订单</a></li>
					<li class="action"><a href="cart.action">我的购物车</a></li>
					<!--<li>
					<a href="contact.html">CONTACT</a>
 
				</li>-->
					<button><span class="postnewcar">不 要 点 我</span></button>
					<shiro:hasPermission name="后台">
						<li class="action"><a href="backhome.action">后台</a></li>
					</shiro:hasPermission>
				</ul>
			</div>
		</nav>
		...
		<div id="carousel-up" class="carousel slide" data-ride="carousel">
			<div class="carousel-inner " role="listbox">
				<div class="item active">
					<a href="productList.action?productId=1"><img
						src="${ctx}/staticfile/img/home/ts.jpg" alt="ts"> </a>
				</div>
				<div class="item">
					<a href="productList.action?productId=6"><img
						src="${ctx}/staticfile/img/home/st.jpg" alt="st"></a>
				</div>
				<div class="item">
					<a href="productList.action?productId=8"><img
						src="${ctx}/staticfile/img/home/zxhy.jpg" alt="zxhy"></a>
				</div>
			</div>
					...
					<div class="txthover">
						...
						<div class="txtcontent">
							...
							<div class="simpletxt">
								<h3 class="name">国学</h3>
								<p>
									"国学书店提供最丰富的国学图书，<br> 书店拥有经部,史部,子部,集部,国学普及书目,辞典,古籍等书籍"
								</p>
								<!-- <form action="productblock.action" method="post">
								<input type="text" value="国学" name="keywords">
								<input type="submit" value="打开书架">
								</form> -->
								<button
									onclick="javascrtpt:window.location.href='productblock.action?keywords=guoxue'">打开书架</button>
								<br>
							</div>
							<div class="stars2">
								<div class="glyphicon glyphicon-star"></div>
					...
					<div class="txthover">
						...
						<div class="txtcontent">
							...
							<div class="simpletxt">
								...
								<p>
									"书店中的经济管理图书，<br> 包括世界及各国经济概况,市场营销,管理学,投资理财,企业经营与管理,贸 易经济"
								</p>
								<button onclick="javascrtpt:window.location.href='productblock.action?keywords=jg'">打开书架</button>
								<br>
							</div>
							<div class="stars2">
								<div class="glyphicon glyphicon-star"></div>
					...
					<div class="txthover">
						...
						<div class="txtcontent">
							...
							<div class="simpletxt">
								<h3 class="name">历史</h3>
								<p>
									"书店历史书籍专区为您陈列了4万多本精美历史书籍，<br>
									内容主题包罗万象,有《明朝那些事儿》,《台湾往事》等中国历史书籍,有《旧制度与大革 命》等欧洲历史书籍等"
								</p>
								<button onclick="javascrtpt:window.location.href='productblock.action?keywords=ls'">打开书架</button>
								<br>
							</div>
							<div class="stars2">
								<div class="glyphicon glyphicon-star"></div>
					...
					<div class="txthover">
						...
						<div class="txtcontent">
							...
							<div class="simpletxt">
								<h3 class="name">少儿</h3>
								<p>
									"少儿图书专区为您精选了海量优质少儿图书作品，<br>
									从幼儿启蒙,儿童文学,手工游戏,科普百科,儿童绘本,儿童教育,少儿英语等超过十万种书籍"
								</p>
								<button onclick="javascrtpt:window.location.href='productblock.action?keywords=sr'">打开书架</button>
								<br>
							</div>
							<div class="stars2">
								<div class="glyphicon glyphicon-star"></div>
					...
					<div class="txthover">
						...
						<div class="txtcontent">
							...
							<div class="simpletxt">
								<h3 class="name">文学</h3>
								<p>
									"文学书店提供最丰富的文学图书，<br> 包括中国文学,外国文学，散文随笔，影视文学等数十万种书籍"
								</p>
								<button onclick="javascrtpt:window.location.href='productblock.action?keywords=wx'">打开书架</button>
								<br>
							</div>
							<div class="stars2">
								<div class="glyphicon glyphicon-star"></div>
					...
					<div class="txthover">
						...
						<div class="txtcontent">
							...
							<div class="simpletxt">
								<h3 class="name">小说</h3>
								<p>
									"小说书店提供最丰富的小说图书，<br> 包括拥有侦探小说，科幻小说，魔幻小说，奇幻小说，恐怖小说等"
								</p>
								<button onclick="javascrtpt:window.location.href='productblock.action?keywords=ls'">打开书架</button>
								<br>
							</div>
					...
					<div class="txthover">
						...
						<div class="txtcontent">
							...
							<div class="simpletxt">
								...
								<p>
									"心理学专区销售的心理学书籍，<br>
									包括销售心理学、心理学与生活、行为心理学、犯罪心理学、教育心理学、社会心理学、心理学与读心术"
								</p>
								<button onclick="javascrtpt:window.location.href='productblock.action?keywords=xl'">打开书架</button>
								<br>
							</div>
							<div class="stars2">
								<div class="glyphicon glyphicon-star"></div>
					...
					<div class="txthover">
						...
						<div class="txtcontent">
							...
							<div class="simpletxt">
								...
								<p>
									"哲学书籍专区我们为您专门检索了数万本古今中外的经典哲学名著<br>
									其中包含了人气最高的马克思哲学、西方哲学、中国哲学、逻辑学、伦理学等等"
								</p>
								<button onclick="javascrtpt:window.location.href='productblock.action?keywords=zx'">打开书架</button>
								<br>
							</div>
							<div class="stars2">
								<div class="glyphicon glyphicon-star"></div>
	...
	<script type="text/javascript"
		src="${ctx}/staticfile/bootstrap-3.3.6-dist/js/jquery.js"></script>
	...
	<script type="text/javascript"
		src="${ctx}/staticfile/bootstrap-3.3.6-dist/js/jquery.1.11.js"></script>
	<script type="text/javascript"
		src="${ctx}/staticfile/bootstrap-3.3.6-dist/js/bootstrap.js"></script>
</body>
</html>